import { calculateGoldCount, calculateHitsCount, calculateRounds, calculateTotal, validScores } from "./scores";
...
describe('calculateRounds', () => {
    test('snapshot test of ruths first competition', () => {
        const scores = [9,9,7,7,3,3,9,9,7,5,5,1,9,7,7,7,5,5,7,7,7,5,5,1,9,7,7,3,3,1,9,9,7,7,5,3,9,7,7,5,5,5,9,9,9,7,7,7,9,9,9,9,7,7,9,9,9,9,9,7,9,7,7,7,7,5,9,7,7,7,7,3,9,9,9,9,7,7,9,9,9,9,9,9,9,9,9,9,9,7,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9,9];
        const gameType = 'windsor';
        const result = calculateRounds(scores, gameType);

        expect(JSON.stringify(result, null, 2)).toMatchFileSnapshot('./__snapshots__/ruths_first_competition.json');
    });
});